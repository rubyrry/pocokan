...
const deleteData = async (nomor) => {
  ...
  // Delphi: BKM dari kasbon tidak bisa dihapus
  if (jurnal.kasbon)
    throw new Error("BKM terbentuk otomatis dari kasbon. Tidak bisa dihapus.");
  ...
  try {
    ...
    // Delphi: hapus jurnal otomatis — MID(jur_no,3,18) untuk BKM
    await conn.query(
